...
* ****Supports Escrow-Like Arrangements:**** Multiple parties involved in a transaction can use a Shared Wallet to  hold funds until agreed conditions are satisfied. Once all required participants approve,  the funds can be released to the designated recipient.
