...
* ****`setPermission()`:**** Grants or revokes withdrawal permission for a specified address. This function manages which addresses are allowed to withdraw funds from the shared wallet. Only the contract owner
