...
* ****`setAllowance(address _user, uint256 _amount)`:**** Assigns or updates the withdrawal allowance for a specified address. The allowance determines the maximum amount of Ether
