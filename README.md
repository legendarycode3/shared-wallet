...
* ****`fallback() external payable`:**** Automatically receives Ether when a transaction includes calldata that does not match any existing function or when Ether is sent with arbitrary data.
